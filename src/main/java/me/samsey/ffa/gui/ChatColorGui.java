...
public class ChatColorGui implements InventoryProvider {
    ...
    public static final SmartInventory INVENTORY = SmartInventory.builder()
            .id("chatColorGui")
            .provider(new ChatColorGui())
            .size(2, 9)
            .title(ChatColor.BLACK + "Colore della chat")
            .build();
    ...
    public void init(Player player, InventoryContents inventoryContents) {
        ...
        ChatColor playerColor = ffaPlayer.getChatColor();
